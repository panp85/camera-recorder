...
package com.pandroid.ftp.swiftp;
...
import com.pandroid.ftp.swiftp.server.SessionThread;
import com.pandroid.ftp.swiftp.server.TcpListener;
import lombok.val;
...
public class FsService extends Service implements Runnable {
    ...
    public static boolean isConnectedToLocalNetwork() {
        ...
        Context context = com.pandroid.App.getAppContext();
