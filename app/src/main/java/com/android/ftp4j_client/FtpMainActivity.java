package com.android.ftp4j_client;
...
import com.android.ftp4j_client.UploadFileChooserAdapter.FileInfo;
...
public class FtpMainActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_main_ftp);
		initView();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.activity_main_ftp_client, menu);
		return true;
	}
